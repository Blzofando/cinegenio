...
import TitleSelector from './shared/TitleSelector'; // 1. IMPORTAÇÃO DO NOVO COMPONENTE

// --- Componentes de Animação e Exibição (permanecem os mesmos) ---
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="w-full max-w-2xl mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
                        {/* 2. USO DO COMPONENTE REUTILIZÁVEL */}
