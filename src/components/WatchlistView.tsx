...
import AddModal from './shared/AddModal'; // ATUALIZADO
import RateModal from './watchlist/RateModal';
import RouletteModal from './watchlist/RouletteModal';
import FilterModal from './watchlist/FilterModal';
...
const WatchlistView: React.FC = () => {
    ...
    // Lógica de adicionar à watchlist agora fica aqui
